-- ============================================================
-- STICKOVER — One-shot FAQ setup (table + categories + seed data)
-- Run this ONE file via phpMyAdmin -> Import, or mysql CLI, on your
-- production database. Safe to re-run (IF NOT EXISTS / INSERT IGNORE).
-- Fixes: FAQ page showing empty / 'FAQs coming soon' because the
-- faqs table did not exist yet or had no category column/data.
-- ============================================================
